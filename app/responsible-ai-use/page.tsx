          ...
          <div className="bg-card border border-border rounded-xl p-8">
            ...
            <div className="mt-8 pt-8 border-t border-border">
              <div className="flex items-start gap-3">
                <Icon name="InformationCircleIcon" size={20} className="text-secondary mt-1" />
                <p className="text-sm text-foreground/70">
                  <strong className="text-primary">Methodology:</strong> Bias testing conducted using industry-standard fairness metrics (demographic parity, equalized odds, calibration) across 10,000+ anonymized interview sessions. Third-party audits performed by AI ethics researchers from partner universities.
                </p>
              </div>
            </div>
          </div>
