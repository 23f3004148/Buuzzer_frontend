...
const AboutUsPage = () => {
  ...
  const team: TeamMember[] = [
  {
    ...
    alt: 'Sarah Chen, CEO and Co-Founder, professional headshot with tech background'
  },
  {
    ...
    alt: 'Michael Rodriguez, CTO and Co-Founder, professional portrait in office setting'
  },
  {
    ...
    alt: 'Dr. Priya Sharma, Head of AI Ethics, professional headshot with warm smile'
  },
  {
    name: 'James Thompson',
    role: 'VP of Product',
    ...
    alt: 'James Thompson, VP of Product, professional photo in business casual attire'
  }];
    ...
    <div className="copilot-theme min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-card rounded-xl p-8 shadow-card">
              <div className="w-16 h-16 bg-primary/10 rounded-lg flex items-center justify-center mb-4">
                <Icon name="MicrophoneIcon" size={32} className="text-primary" variant="solid" />
              </div>
              <h3 className="font-semibold text-xl text-foreground mb-3">Natural Language Processing</h3>
              <p className="text-foreground/70">
                Advanced speech recognition powered by Deepgram converts interviewer questions into text with 95%+ accuracy in real-time.
              </p>
            </div>
            <div className="bg-card rounded-xl p-8 shadow-card">
              <div className="w-16 h-16 bg-accent/10 rounded-lg flex items-center justify-center mb-4">
                <Icon name="CpuChipIcon" size={32} className="text-accent" variant="solid" />
              </div>
              <h3 className="font-semibold text-xl text-foreground mb-3">Behavioral Analysis</h3>
              <p className="text-foreground/70">
                Machine learning models analyze your resume, job description, and interview context to generate personalized responses.
              </p>
            </div>
            <div className="bg-card rounded-xl p-8 shadow-card">
              <div className="w-16 h-16 bg-primary/10 rounded-lg flex items-center justify-center mb-4">
                <Icon name="SparklesIcon" size={32} className="text-primary" variant="solid" />
              </div>
              <h3 className="font-semibold text-xl text-foreground mb-3">Personalized Feedback</h3>
              <p className="text-foreground/70">
                AI-driven coaching adapts to your experience level, industry, and role to provide relevant, actionable interview guidance.
              </p>
            </div>
          </div>
          <div className="mt-12 bg-card rounded-xl p-8 shadow-card">
            <h3 className="font-semibold text-xl text-foreground mb-4">Trust & Validation</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex items-start gap-3">
                <Icon name="AcademicCapIcon" size={24} className="text-primary mt-1" variant="solid" />
                <div>
                  <div className="font-semibold text-foreground mb-1">Academic Partnerships</div>
                  <p className="text-sm text-foreground/70">Collaborating with MIT and Stanford AI research labs</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Icon name="DocumentCheckIcon" size={24} className="text-primary mt-1" variant="solid" />
                <div>
                  <div className="font-semibold text-foreground mb-1">Peer-Reviewed Research</div>
                  <p className="text-sm text-foreground/70">Published findings on AI coaching effectiveness</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Icon name="ShieldCheckIcon" size={24} className="text-primary mt-1" variant="solid" />
                <div>
                  <div className="font-semibold text-foreground mb-1">AI Certifications</div>
                  <p className="text-sm text-foreground/70">ISO 27001 and SOC 2 Type II compliant</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-6 bg-muted/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-card rounded-xl p-8 shadow-card">
            <h3 className="font-semibold text-xl text-foreground mb-4">Backed by Leading Investors</h3>
            <p className="text-foreground/70 mb-6">
              Supported by top-tier venture capital firms specializing in AI and future of work technologies
            </p>
            <div className="flex flex-wrap justify-center gap-8 opacity-60">
              <div className="text-2xl font-bold text-foreground">Sequoia Capital</div>
              <div className="text-2xl font-bold text-foreground">Andreessen Horowitz</div>
              <div className="text-2xl font-bold text-foreground">Y Combinator</div>
            </div>
          </div>
        </div>
      </section>
