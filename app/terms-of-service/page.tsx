  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      content: [
        ...
        'DISPUTE RESOLUTION PROCESS: (a) Step 1: Contact customer support at support@interviewcopilot.com to resolve informally, (b) Step 2: If unresolved within 30 days, proceed to mediation, (c) Step 3: If mediation fails, proceed to binding arbitration.',
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-card rounded-lg p-6 shadow-card">
              ...
              <p className="font-body text-foreground">
                <strong>Email:</strong> support@interviewcopilot.com<br />
            ...
            <div className="bg-card rounded-lg p-6 shadow-card">
              ...
              <p className="font-body text-foreground mb-4">
                For formal legal inquiries or notices, contact our legal team.
              </p>
              <p className="font-body text-foreground">
                <strong>Email:</strong> legal@interviewcopilot.com<br />
                <strong>Mail:</strong> Legal Department<br />Interview Copilot Inc.<br />123 Privacy Lane<br />San Francisco, CA 94105
              </p>
            </div>
          </div>
        </div>
