...
const PrivacyPolicyPage = () => {
  ...
  const thirdPartyServices = [
    ...
    },
    {
      ...
      dataShared: 'Anonymized usage patterns, device information',
    ...
    <div className="copilot-theme min-h-screen bg-background">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center">
                  <span className="font-cta font-bold text-accent">1</span>
                </div>
                <div className="flex-1">
                  <h4 className="font-headline text-lg font-semibold text-primary mb-1">Audio Capture</h4>
                  <p className="font-body text-foreground">Chrome Extension captures interviewer audio only (not your voice)</p>
                </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center">
                  <span className="font-cta font-bold text-accent">2</span>
                </div>
                <div className="flex-1">
                  <h4 className="font-headline text-lg font-semibold text-primary mb-1">Encrypted Transmission</h4>
                  <p className="font-body text-foreground">Audio sent via TLS 1.3 to Deepgram transcription service</p>
                </div>
                <Icon name="LockClosedIcon" size={24} className="text-success" variant="solid" />
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center">
                  <span className="font-cta font-bold text-accent">3</span>
                </div>
                <div className="flex-1">
                  <h4 className="font-headline text-lg font-semibold text-primary mb-1">AI Processing</h4>
                  <p className="font-body text-foreground">Transcribed text + your resume context sent to OpenAI for response generation</p>
                </div>
                <Icon name="LockClosedIcon" size={24} className="text-success" variant="solid" />
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center">
                  <span className="font-cta font-bold text-accent">4</span>
                </div>
                <div className="flex-1">
                  <h4 className="font-headline text-lg font-semibold text-primary mb-1">Secure Storage</h4>
                  <p className="font-body text-foreground">Session data encrypted with AES-256 and stored in secure databases</p>
                </div>
                <Icon name="LockClosedIcon" size={24} className="text-success" variant="solid" />
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center">
                  <span className="font-cta font-bold text-accent">5</span>
                </div>
                <div className="flex-1">
                  <h4 className="font-headline text-lg font-semibold text-primary mb-1">User Control</h4>
                  <p className="font-body text-foreground">You can view, download, or delete your data anytime from your dashboard</p>
                </div>
      ...
      <section className="py-16 px-6 bg-muted">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card rounded-lg p-8 shadow-card">
            <p className="font-body text-lg text-foreground mb-6">
              We use cookies to improve your experience and analyze service performance. You have full control over what's tracked:
            </p>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                <div>
                  <h4 className="font-headline text-lg font-semibold text-primary mb-1">Essential Cookies</h4>
                  <p className="font-body text-muted-foreground">Required for authentication and core functionality</p>
                </div>
                <span className="font-cta text-sm text-muted-foreground">Always Active</span>
              </div>
              <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                <div>
                  <h4 className="font-headline text-lg font-semibold text-primary mb-1">Analytics Cookies</h4>
                  <p className="font-body text-muted-foreground">Help us understand usage patterns and improve features</p>
                </div>
                <button className="font-cta px-4 py-2 rounded-lg bg-accent text-accent-foreground hover:bg-accent/90 transition-colors duration-250">
                  Manage
                </button>
              </div>
              <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                <div>
                  <h4 className="font-headline text-lg font-semibold text-primary mb-1">Marketing Cookies</h4>
                  <p className="font-body text-muted-foreground">Used for personalized content and advertising</p>
                </div>
                <button className="font-cta px-4 py-2 rounded-lg bg-accent text-accent-foreground hover:bg-accent/90 transition-colors duration-250">
                  Manage
                </button>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card rounded-lg p-8 shadow-card">
            <div className="space-y-6">
              <div>
                <h4 className="font-headline text-lg font-semibold text-primary mb-3">How Long We Keep Your Data</h4>
                <ul className="space-y-2 font-body text-foreground">
                  ...
                  <li>• <strong>Interview Session Data:</strong> Stored for 90 days, then automatically deleted</li>
              ...
              <div>
                <h4 className="font-headline text-lg font-semibold text-primary mb-3">Automated Deletion</h4>
                <p className="font-body text-foreground">
                  You can schedule automatic deletion of interview recordings immediately after each session, or set retention periods from 7 to 90 days. Once deleted, data cannot be recovered.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-6 bg-muted">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-card rounded-lg p-8 shadow-card">
            <p className="font-body text-lg text-foreground mb-6">
              Interview Copilot operates globally. Your data may be transferred to and processed in countries outside your residence, including the United States. We ensure all transfers comply with applicable data protection laws through:
            </p>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Icon name="CheckCircleIcon" size={24} className="text-success flex-shrink-0 mt-0.5" variant="solid" />
                <span className="font-body text-foreground">Standard Contractual Clauses (SCCs) approved by the European Commission</span>
              </li>
              <li className="flex items-start gap-3">
                <Icon name="CheckCircleIcon" size={24} className="text-success flex-shrink-0 mt-0.5" variant="solid" />
                <span className="font-body text-foreground">Data Processing Agreements with all third-party processors</span>
              </li>
              <li className="flex items-start gap-3">
                <Icon name="CheckCircleIcon" size={24} className="text-success flex-shrink-0 mt-0.5" variant="solid" />
                <span className="font-body text-foreground">Equivalent data protection safeguards in all jurisdictions</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-card rounded-lg p-6 shadow-card">
              <Icon name="BellAlertIcon" size={32} className="text-accent mb-4" />
              <h3 className="font-headline text-xl font-semibold text-primary mb-3">
                Policy Updates
              </h3>
              <p className="font-body text-foreground mb-4">
                We'll notify you via email of any material changes to this Privacy Policy. You can view version history and compare changes in your account settings.
              </p>
              <button className="font-cta text-accent hover:text-accent/80 font-semibold transition-colors duration-250">
            ...
            <div className="bg-card rounded-lg p-6 shadow-card">
              <Icon name="EnvelopeIcon" size={32} className="text-accent mb-4" />
              <h3 className="font-headline text-xl font-semibold text-primary mb-3">
                Privacy Questions?
              </h3>
              <p className="font-body text-foreground mb-4">
                Our Data Protection Officer is available to answer any privacy-related questions or concerns.
              </p>
              <div className="space-y-2 font-body text-foreground">
                <p><strong>Email:</strong> privacy@interviewcopilot.com</p>
                <p><strong>Mail:</strong> Data Protection Officer<br />Interview Copilot Inc.<br />123 Privacy Lane<br />San Francisco, CA 94105</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-muted">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="flex items-center gap-3">
              <Icon name="ShieldCheckIcon" size={32} className="text-success" variant="solid" />
              <span className="font-cta text-lg font-semibold text-foreground">ISO 27001 (In Progress)</span>
            </div>
          </div>
        </div>
      </section>
